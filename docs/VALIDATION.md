...
| Paroi immergée **+ AMR multi-niveaux** (`AmrML`, 3 niv.) | `immersed_amr` | p paroi vs exact (masque à chaque niveau) | 15.03 (**0.21 %**, 16 patches) |
...
| **Blasius sur plaque immergée** (no-slip visqueux) | `immersed_noslip` | profil vs f', Cf vs 0.664/√Re_x | RMS **0.7 %** ; Cf **3 %** (Re_x≈1600) |
